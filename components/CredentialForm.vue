<template>
  <div class="credential-form">
    <div class="credential-form__box mb-4 d-flex justify-content-center">
      <div>
        <b-input
          v-model="credential.name"
          size="sm"
          placeholder="Enter a credential name"
          class="credential-form__credential-name mb-3"
          required
        ></b-input>
        <CredentialField
        ...
        />
        <b-container class="credential-form__controls mt-4 px-0">
